...
i'm a group manager bot. Maintained by @Farseen_king_of_telegram❤
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="👰 Add 𝙂𝙞𝙜𝙞 𝙃𝙖𝙙𝙞𝙙 to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="Support Group",
                             url=f"https://t.me/https://t.me/joinchat/VG1UwkSWRDguP6l3"),
                           
                         InlineKeyboardButton(
                             text="📘 Logs",
                             url="https://t.me/joinchat/Jhp2gINqm8RhNTc1")
                     ],
                     [
                         InlineKeyboardButton(
                             text="☑️ Source code",
                             url="https://t.me/joinchat/T5xUgH67JIQmxbUu")
                     ]]))
    else:
